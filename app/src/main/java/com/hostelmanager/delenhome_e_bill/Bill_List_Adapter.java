...
public class Bill_List_Adapter extends BaseAdapter {

    private final List<Bill_Detail> bill_lists;
    private final Context context;

    Bill_List_Adapter(Context context, List<Bill_Detail> bill_lists) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(context,AllBillDetail.class);
